<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Wizard3.aspx.vb" Inherits="Test_FinalWizard" %>
...
<div class="nav-area"> 
      ...
      <li><a href="http://ec2-3-21-135-95.us-east-2.compute.amazonaws.com/unicorn_riders/WebsitePages/Account.aspx"><span class="material-icons">face</span> Account</a></li>
        <li><a href="http://ec2-3-21-135-95.us-east-2.compute.amazonaws.com/WebsitePages/Logout.aspx"><span class="material-icons">clear</span> Log Out</a></li>
    </ul>  
    </div>
</div>
</div>
  ...
  <a href="#">Monitors</a>--%>
        ...
        <p style='font-family:"Microsoft JhengHei Light",Microsoft JhengHei UI;font-size:150%'">
            When it comes to my workstation, I want to:</p>
                        <p>
            <asp:Button ID="btnSave" runat="server" class="btn" Text="Save some money" ForeColor="White" />
            <asp:Button ID="btnSpend" runat="server" class="btn" Text="Work with the best" ForeColor="White" />
                            <br />
                            &nbsp;&nbsp;
            </p>
        <p>
