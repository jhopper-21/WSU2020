<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Data1.aspx.vb" Inherits="WebsitePages_Data" Debug="true" %>
...
<div class="nav-area"> 
    ...
    <form id="form1" runat="server">
        ...
        <br />
         ...
         <asp:AccessDataSource ID="AccessDataSource5" runat="server" DataFile="../App_Data/ProjectDatabase42.mdb" SelectCommand="SELECT [EmployeeID], [EmployeeName] FROM [Employee] ORDER BY [EmployeeID]" OldValuesParameterFormatString="original_{0}">
            </asp:AccessDataSource>
         <asp:AccessDataSource ID="AccessDataSource6" runat="server" DataFile="../App_Data/ProjectDatabase42.mdb" SelectCommand="SELECT DISTINCT COUNT(OrderID) AS Expr1 FROM [Order] WHERE (EmployeeID = ?)" OldValuesParameterFormatString="original_{0}">
             <SelectParameters>
                 <asp:ControlParameter ControlID="DropDownList3" Name="?" PropertyName="SelectedValue" />
             </SelectParameters>
            </asp:AccessDataSource>
         <asp:AccessDataSource ID="AccessDataSource7" runat="server" DataFile="../App_Data/ProjectDatabase42.mdb" SelectCommand="SELECT SUM(Price) AS TotalSpent FROM OrderDetails WHERE (EmployeeID = ?)" OldValuesParameterFormatString="original_{0}">
             <SelectParameters>
                 <asp:ControlParameter ControlID="DropDownList3" Name="?" PropertyName="SelectedValue" />
             </SelectParameters>
            </asp:AccessDataSource>
...
WHERE EmployeeID = ?" OldValuesParameterFormatString="original_{0}">
         ...
         <asp:AccessDataSource ID="AccessDataSource12" runat="server" DataFile="../App_Data/ProjectDatabase42.mdb" SelectCommand="SELECT DISTINCT COUNT(OrderStatus) AS Expr1 FROM [Order]
WHERE EmployeeID = ?
 GROUP BY OrderStatus" OldValuesParameterFormatString="original_{0}">
             <SelectParameters>
                 <asp:ControlParameter ControlID="DropDownList3" Name="?" PropertyName="SelectedValue" />
             </SelectParameters>
            </asp:AccessDataSource>
         ...
         <asp:AccessDataSource ID="AccessDataSource14" runat="server" DataFile="../App_Data/ProjectDatabase42.mdb" SelectCommand="SELECT SUM(Price) AS TotalSpent FROM OrderDetails" OldValuesParameterFormatString="original_{0}">
            </asp:AccessDataSource>
...
ORDER by OrderStatus DESC" OldValuesParameterFormatString="original_{0}">
         ...
         <asp:AccessDataSource ID="AccessDataSource18" runat="server" DataFile="../App_Data/ProjectDatabase42.mdb" SelectCommand="SELECT DISTINCT COUNT(OrderStatus) AS Expr1 FROM [Order]
 GROUP BY OrderStatus" OldValuesParameterFormatString="original_{0}">
            </asp:AccessDataSource>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource7" ForeColor="#333333" GridLines="None" Visible="False" Width="196px">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="TotalSpent" DataFormatString="{0:c}" HeaderText="Total Spent ($)" SortExpression="TotalSpent" />
            </Columns>
            <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource8" ForeColor="#333333" Width="247px" GridLines="None" Visible="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="Expr1" DataFormatString="{0:c}" HeaderText="Average Order Price" ReadOnly="True" SortExpression="Expr1" />
            </Columns>
            <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
        ...
        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource9" ForeColor="#333333" GridLines="None" Visible="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
        ...
        <br />
            ...
            <div class="auto-style9">
        <table  >
        <asp:GridView ID="GridView11" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource16" ForeColor="#333333" GridLines="None" Visible="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
        ...
        <table>
            <tr>
                <td class="auto-style6">
                    <div class="auto-style9">
        <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource11" ForeColor="#333333" GridLines="None" Width="145px" Visible="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
        ...
        <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource12" ForeColor="#333333" GridLines="None" Visible="False" Width="185px">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="Expr1" HeaderText="Number of Decisions" SortExpression="Expr1">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
            <EditRowStyle BackColor="#2461BF" />
        ...
        <br />
         ...
         <table>
            <tr>
                <td class="auto-style6">
        <asp:GridView ID="GridView12" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource17" ForeColor="#333333" GridLines="None" Width="146px" Visible="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="OrderStatus" HeaderText="Order Status" SortExpression="OrderStatus">
                <ItemStyle HorizontalAlign="Center" />
            ...
            <SortedDescendingHeaderStyle BackColor="#4870BE" />
                ...
                <td class="text-center">
        <asp:GridView ID="GridView13" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AccessDataSource18" ForeColor="#333333" GridLines="None" Visible="False" Width="185px">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="Expr1" HeaderText="Number of Decisions" SortExpression="Expr1">
                <ItemStyle HorizontalAlign="Center" />
